...
void loop() 
{
  ...
  //-------------------------
  int hoek_naar_bakje = hoek_bakje_groen;
  
  // TODO:
  // Schrijf op deze plek code die er voor zorgt dat
  // de servo naar de hoek in variabel "hoek_bakje_rood"
  // gaat wanneer er meer rood is gemeten dan groen en blauw.
  // Dit doe je door de variabel "hoek_naar_bakje" te vullen
  // met de variabel "hoek_bakje_rood".
  //
  // Doe hetzelfde voor het geval dat er meer groen is gemeten
  // dan rood en blauw. Gebruik de variabel "hoek_bakje_groen".
  //
  // Doe hetzelfde voor het geval dat er meer blauw is gemeten
  // dan rood en groen. Gebruik de variabel "hoek_bakje_blauw".
